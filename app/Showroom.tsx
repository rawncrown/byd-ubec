...
const vehicles: Vehicle[] = [
  { name: "BYD Seagull", type: "Full Electric", body: "Mini Hatchback", price: 968000, range: "300 km", rangeLabel: "EV range (NEDC)", power: "75 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ab4f88ebea20adf205cccc_BYD-Seagull-HomePageBanner-1440x900.webp", bestFor: "First EV & city driving", highlights: ["Compact and easy to park", "Blade Battery", "Smart, connected cabin"], source: "https://bydcarsphilippines.com/vehicles/byd-seagull" },
  { name: "BYD Seal 5 DM-i", type: "Super DM-i", body: "Compact Sedan", price: 958000, range: "1,175 km", rangeLabel: "combined range", power: "179 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ab598f1fb310631d02fd4d_BYD-Seal5-DMi-HomePageBanner-1440x900.webp", bestFor: "Maximum value & long drives", highlights: ["Up to 50 km pure EV driving", "12.8-inch rotating screen", "Generous 450 L trunk"], source: "https://bydcarsphilippines.com/vehicles/byd-seal-5-dm-i-dynamic" },
  { name: "BYD Sealion 5 DM-i", type: "Super DM-i", body: "Compact SUV", price: 1268000, range: "1,001 km", rangeLabel: "combined range", power: "197 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/69dce0d3385a98fab9775253_684fb8bf016df4905008594a_BYD-Sealion5-DMi-HomePageBanner-1440x900%20copy.avif", bestFor: "Practical family SUV", highlights: ["Up to 71 km pure EV driving", "Roomy SUV cabin", "360-degree camera"], source: "https://bydcarsphilippines.com/vehicles/byd-sealion-5-dm-i" },
  { name: "BYD Dolphin", type: "Full Electric", body: "Hatchback", price: 1438000, range: "405 km", rangeLabel: "EV range (NEDC)", power: "95 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ab341bd290fad16c2b6142_BYD-Dolphin-HomePageBanner-1440x900.webp", bestFor: "Urban life with more room", highlights: ["Five-star ANCAP safety", "360-degree camera", "Flexible 1,310 L cargo space"], source: "https://bydcarsphilippines.com/vehicles/byd-dolphin" },
  { name: "BYD eMAX 7", type: "Full Electric", body: "MPV", price: 1548000, range: "420 km", rangeLabel: "EV range (NEDC)", power: "163 Ps", seats: "6 or 7 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67f3b0881ff49accc6102e7b_BYD-eMAX7-HomePageBanner-1440x900.webp", bestFor: "Modern family space", highlights: ["Six- or seven-seat variants", "Vehicle-to-load capability", "DiPilot driver assistance"], source: "https://bydcarsphilippines.com/vehicles/byd-emax-7-standard" },
  { name: "BYD Sealion 6 DM-i", type: "Super DM-i", body: "Compact SUV", price: 1598000, range: "1,100 km", rangeLabel: "combined range", power: "217 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/69dcdf1f9a9f30f23464afa4_6879e8e362008e7349e43492_BYD-Sealion6-Dmi-HomePageBanner-StoneGrey-1440x900.avif", bestFor: "Premium everyday flexibility", highlights: ["Up to 105 km pure EV driving", "15.6-inch rotating screen", "Advanced driver assistance"], source: "https://bydcarsphilippines.com/vehicles/byd-sealion-6-dm-i" },
  { name: "BYD Atto 3", type: "Full Electric", body: "Compact SUV", price: 1638000, range: "410 km", rangeLabel: "EV range (NEDC)", power: "204 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/69281e6eec0fcd9d7c3f650f_byd%20atto%203%20-%20Dynamic%20-%20Hero.webp", bestFor: "Tech-forward compact SUV", highlights: ["Five-star Euro NCAP safety", "Spacious 1,340 L max cargo", "7.3-second 0–100 km/h"], source: "https://bydcarsphilippines.com/vehicles/byd-atto-3-dynamic" },
  { name: "BYD Tang DM-i", type: "Super DM-i", body: "Mid-size SUV", price: 2148000, range: "1,160 km", rangeLabel: "combined range", power: "271 Ps", seats: "7 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/68c3c0bf12a2c833eefa3d62_BYD%20Tang%20DM-i_Web%20Assets_Product%20Banner%20copy.webp", bestFor: "Seven-seat long-distance travel", highlights: ["Seven-seat versatility", "Up to 150 km pure EV range", "Premium family comfort"], source: "https://bydcarsphilippines.com/vehicles/byd-tang-dm-i" },
  { name: "BYD Shark 6 DMO", type: "DMO", body: "Pickup Truck", price: 2388000, range: "800 km", rangeLabel: "combined range", power: "435 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ca6465cefc7e873cb1b359_BYD-Shark6-DMO-HomePageBannerB-1440x900c.webp", bestFor: "Work, adventure & towing", highlights: ["All-wheel drive", "2,500 kg towing capacity", "700 mm wading depth"], source: "https://bydcarsphilippines.com/vehicles/byd-shark-6-dmo-advanced" },
  { name: "BYD Sealion 7", type: "Full Electric", body: "Performance SUV", price: 2588000, range: "542 km", rangeLabel: "EV range (NEDC)", power: "530 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/6a0429cc1a2598bd101080ee_BYD-SL7i-HomePageBanner-1440x900.webp", bestFor: "Premium electric performance", highlights: ["4.5-second 0–100 km/h", "AWD with 690 Nm", "Nine airbags and DiPilot"], source: "https://bydcarsphilippines.com/vehicles/byd-sealion-7" },
  { name: "BYD Seal", type: "Full Electric", body: "Performance Sedan", price: 2098000, range: "Up to 580 km", rangeLabel: "EV range (NEDC)", power: "Up to 529 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ab5fd0cce3dedd87fcf714_BYD-SealEv-HomePageBanner-1440x900.webp", bestFor: "Sporty electric driving", highlights: ["Advanced and Performance variants", "Up to 3.8-second 0–100 km/h", "Award-winning design"], source: "https://bydcarsphilippines.com/vehicles/byd-seal-performance" },
  { name: "BYD eMAX 9 DM-i", type: "Super DM-i", body: "Luxury MPV", price: 2778000, range: "Up to 1,240 km", rangeLabel: "combined range", power: "271 Ps", seats: "7 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/68f26f9848eb66807b90b15d_BYD-eMAX9-DMi-PremiumPageBanner-1440x900.webp", bestFor: "First-class family travel", highlights: ["Premium seven-seat comfort", "Up to 170 km pure EV range", "Power sliding doors"], source: "https://bydcarsphilippines.com/vehicles/byd-emax-9-dm-i-advanced" },
  { name: "BYD Han", type: "Full Electric", body: "Executive Sedan", price: 3213000, range: "521 km", rangeLabel: "EV range (WLTP)", power: "515 Ps", seats: "5 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ab473c8fcc7057d6f44ac8_BYD-Han-HomePageBanner-1440x900.webp", bestFor: "Executive electric luxury", highlights: ["3.9-second 0–100 km/h", "Electric all-wheel drive", "Nappa leather interior"], source: "https://bydcarsphilippines.com/vehicles/byd-han" },
  { name: "BYD Tang", type: "Full Electric", body: "Performance SUV", price: 3421000, range: "530 km", rangeLabel: "EV range (NEDC)", power: "517 Ps", seats: "7 seats", image: "https://cdn.prod.website-files.com/679b275acc89c99e5cf128aa/67ab4334ed3aeeaf54e27292_BYD-Tang-HomePageBanner-1440x900.webp", bestFor: "Seven-seat electric performance", highlights: ["Dual-motor all-wheel drive", "Premium seven-seat cabin", "Advanced safety suite"], source: "https://bydcarsphilippines.com/vehicles/byd-tang" },
];
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button primary" href="#models">Explore 14 models</a><a className="text-link" href="#proposal">Request a proposal <span>→</span></a></div>
        ...
        <div className="hero-visual">
          <img src={vehicles[9].image} alt="BYD Sealion 7 electric performance SUV" />
          <div className="hero-model"><span>Featured</span><strong>BYD Sealion 7</strong><small>542 km range · 530 Ps · AWD</small></div>
      ...
      <section className="models" id="models">
        ...
        <p className="price-note">Suggested retail prices shown are based on BYD Cars Philippines information valid as of May 27, 2026. Prices, specifications, colors, stock and provincial charges may change without prior notice.</p>
      </section>
      ...
      <section className="proposal" id="proposal">
        ...
        <form className="lead-form" onSubmit={submit}>
          {submitted ? <div className="success"><span>✓</span><h3>Your request is ready.</h3><p>The website inquiry flow is working. Direct lead delivery will be connected to Ron’s Proposal Generator in the next setup step.</p><button type="button" className="button primary" onClick={() => setSubmitted(false)}>Send another request</button></div> : <>
            ...
            <button className="submit-button" type="submit">Request my proposal <span>↗</span></button>
